...
def insertInscricao(event, context):    
    ...
    try:        
        ...
        nomeColunas = ("Numero_de_inscricao","Grupo_Categoria","Categoria","Nome_Completo","Data_de_nascimento","E_mail","Tipo_de_Documento","Documento","Sexo","CAMISETA","CAMISETA_KIDS","Kit_Entregue","Nome_Entregue","Data_Entregue")        
